...
test_folder = "C:/Users/ahlre/Documents/GitProjects/Competitive_Programming/Cases/2023f3pj_mecanica/4"

# Caminho para o executável ou script da sua solução
solution_executable = "C:/Users/ahlre/Documents/GitProjects/Competitive_Programming/OBI/2023/3°fase/mecanica.exe"  # Pode ser './a.sol', 'python solucao.py', etc.
